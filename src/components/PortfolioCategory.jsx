    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-white py-20 pt-32">
        ...
        >
          ...
          <Link
            to="/portfolio"
            className="inline-flex items-center justify-center rounded-full bg-teal-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-teal-600/25 transition-all hover:bg-teal-700 hover:shadow-xl hover:shadow-teal-600/30"
          >
            Back to Portfolio
          </Link>
        </motion.div>
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-20 bg-gradient-to-b from-white via-slate-50/50 to-white overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-30">
          <div className="absolute top-20 right-10 w-72 h-72 bg-teal-100/50 rounded-full blur-3xl" />
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 xl:px-20 z-10">
          ...
          >
            {categoryData.projects.map((project, index) => (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-2xl bg-white border border-slate-200 hover:border-teal-300 hover:shadow-xl transition-all"
              >
                {/* Image */}
                <div className="relative h-48 sm:h-56 md:h-64 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4">
                    <span className="px-3 py-1 rounded-full bg-teal-600/90 backdrop-blur-sm text-white text-xs font-semibold">
                      {project.status}
                    </span>
                  </div>
                </div>
          ...
          {/* CTA Section */}
          <motion.div
            className="mt-12 sm:mt-20 text-center bg-gradient-to-br from-teal-50 to-blue-50 p-6 sm:p-12 rounded-2xl border border-slate-200 shadow-lg"
            initial={{ opacity: 0, y: 30 }}
          ...
          >
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-900 mb-4 sm:mb-6 px-4">
              Ready to Start Your <span className="text-teal-600">Project?</span>
            </h2>

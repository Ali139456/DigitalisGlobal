...
const ServiceDetail = () => {
  ...
  const servicesData = {
    ...
    'artificial-intelligence': {
      ...
      description: 'AI-powered solutions that automate processes and provide intelligent insights for your business. Transform operations with cutting-edge AI.',
      longDescription: 'Leverage the power of artificial intelligence to automate tasks, gain insights, and create smarter products that adapt to user needs.',
      image: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=1200&q=80',
      icon: '🤖',
      features: [
        {
          title: 'Machine Learning',
          desc: 'Custom ML models for your specific use cases'
        },
        {
          title: 'Natural Language Processing',
          desc: 'Text analysis, sentiment, and language understanding'
        },
        {
          title: 'Computer Vision',
          desc: 'Image recognition and visual analysis'
        },
        {
        ...
        },
        {
          ...
          desc: 'Seamlessly integrate AI into existing systems'
        }
      ],
      technologies: ['Python', 'TensorFlow', 'PyTorch', 'OpenAI', 'Azure AI', 'AWS ML', 'Hugging Face']
    },
    'ar-vr': {
      title: 'AR/VR Development',
      description: 'Immersive augmented and virtual reality experiences that engage users in new dimensions. Push boundaries with cutting-edge technology.',
      longDescription: 'Create unforgettable experiences that blend the digital and physical worlds, opening new possibilities for training, marketing, and entertainment.',
      image: 'https://images.unsplash.com/photo-1593508512255-86ab42a8e620?w=1200&q=80',
      icon: '🕶️',
      features: [
        {
          title: 'AR Mobile Apps',
          desc: 'Augmented reality experiences for iOS and Android'
        },
        {
          title: 'VR Experiences',
          desc: 'Immersive virtual reality applications'
        },
        {
          title: '3D Modeling',
          desc: 'Custom 3D assets and environments'
        },
        {
          title: 'Interactive Simulations',
          desc: 'Training and educational VR experiences'
        },
        {
          title: 'Mixed Reality',
          desc: 'Blend AR and VR for unique experiences'
        },
        {
          title: 'Hardware Integration',
          desc: 'Support for Oculus, HoloLens, and more'
        }
      ],
      technologies: ['Unity', 'Unreal Engine', 'ARKit', 'ARCore', 'WebXR', 'Blender', 'Three.js']
    }
  }
